...
- **Experience Offering**: Public-facing description of a service, event, or curated itinerary presented to anonymous and authenticated audiences. Offerings expose availability, pricing signals, taxonomy tags, and guide attribution.
- **Guide Persona**: Profile representing a human specialist or AI assistant capable of delivering experiences or learning journeys. Personas maintain biography, capability tags, ratings, and links to owned offerings.
- **Event Listing**: Time-bound manifestation of an experience, including schedule slots, capacity, location metadata, and associated offering snapshot.
- **Venue Node**: Geospatial anchor that aggregates map coordinates, accessibility details, media, and contact points for venues referenced across agendas, offerings, and logistics.
