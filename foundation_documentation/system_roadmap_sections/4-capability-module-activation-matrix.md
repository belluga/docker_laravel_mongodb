...
| --- | --- | --- | --- | --- |
| Foundation Control Plane | Landlord and tenant provisioning, identity_state lifecycle management (anonymous → registered → validated), capability manifests, and account credential governance. | Tenant, Account, Identity Actor | P0 | In Design |
